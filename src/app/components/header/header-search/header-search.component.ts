...
import { InputRestrictionDirective } from '@core/directives/input-restrict.directive';
...
export class HeaderSearchComponent implements OnInit, OnDestroy {
	...
	protected symbols: SymbolSearchModel[];
	...
	public onSearch(request: SymbolSearchRequest): void {
		this.symbolService.search(request)
			.pipe(first())
			.subscribe((response: SymbolSearchModel[]) => {
				if (response.length) {
